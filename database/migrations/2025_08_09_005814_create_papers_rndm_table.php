...
return new class extends Migration
{
  public function up()
    {
        Schema::create('papers_rndm', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('SALBASE', 14, 2)->nullable();
            ...
            $table->decimal('BRUTMENS', 14, 2)->nullable();
            $table->decimal('TAUX', 14, 2)->nullable();
            $table->decimal('JRPRIME', 14, 2)->nullable();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('papers_rndm');
    }
};
