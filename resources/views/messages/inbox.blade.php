    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ البريد الوارد</span>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title mg-b-0"><i class="fa-solid fa-envelope-open-text side-menu__icon"></i>البريد
                            الوارد
                        </h4>
                    </div>
                </div>
                <div class="main-content-body main-content-body-mail card-body">
                    ...
                    <form id="deleteMessagesForm" action="{{ route('messages.delete') }}" method="POST">
                        ...
                        <div class="message-item">
                            ...
                            @empty
                                <div class="alert alert-warning text-center">لا توجد رسائل في البريد الوارد</div>
                            @endforelse
                        </div>
                    </form>
