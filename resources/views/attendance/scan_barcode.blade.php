                        ...
                        <form id="scanForm" action="{{ route('attendance.scan.post') }}" method="POST">
                            ...
                            <div class="scan-input-wrapper">
                                <input autofocus autocomplete="off" type="text" name="code" id="code"
                                    class="form-control scan-input" placeholder="مرر القارئ هنا..." required
                                    minlength="1" />
        ...
        <div class="col-lg-5 mb-4">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-0">
                    ...
                    <p id="result" style="text-align:center;font-size:20px;color:green;"></p>
                </div>
            </div>
        </div>
    </div>
...
@section('js')
    ...
    <script>
        const scanner = new Html5QrcodeScanner('reader', {
            ...
            fps: 10, // سرعة أقل لتقليل الضغط على المعالجة
        });
        ...
        function error(err) {
            document.getElementById('result').innerText = "لم يتم العثور على كود QR بعد...";
        }
    </script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                submitBtn.innerHTML =
                    '<span class="spinner-border spinner-border-sm me-2"></span>جاري التسجيل...';
